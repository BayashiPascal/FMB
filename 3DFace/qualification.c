...
void Qualify3DStatic(TypeQualif typeQualif) {
  ...
  if (typeQualif == typeQualif_all) {
    ...
    fp = fopen("../Results/qualification3DFace.txt", "w");
    fpCC = fopen("../Results/qualification3DFaceCC.txt", "w");
    fpCT = fopen("../Results/qualification3DFaceCT.txt", "w");
    fpTC = fopen("../Results/qualification3DFaceTC.txt", "w");
    fpTT = fopen("../Results/qualification3DFaceTT.txt", "w");

  } else if (typeQualif == typeQualif_nearCaseOnly) {

    fp = fopen("../Results/qualification3DFacenearcaseonly.txt", "w");
    fpCC = fopen("../Results/qualification3DFaceCCnearcaseonly.txt", "w");
    fpCT = fopen("../Results/qualification3DFaceCTnearcaseonly.txt", "w");
    fpTC = fopen("../Results/qualification3DFaceTCnearcaseonly.txt", "w");
    fpTT = fopen("../Results/qualification3DFaceTTnearcaseonly.txt", "w");
  ...
  for (
    ...
    for (
      ...
      for (
        ...
        param->comp[2][0] =
          param->comp[0][1] * param->comp[1][2] -
          param->comp[0][2] * param->comp[1][1];
        param->comp[2][1] =
          param->comp[0][2] * param->comp[1][0] -
          param->comp[0][0] * param->comp[1][2];
        param->comp[2][2] =
          param->comp[0][0] * param->comp[1][1] -
          param->comp[0][1] * param->comp[1][0];
        double l =
          sqrt(
            param->comp[2][0] * param->comp[2][0] +
            param->comp[2][1] * param->comp[2][1] +
            param->comp[2][2] * param->comp[2][2]);
        param->comp[2][0] /= l;
        param->comp[2][1] /= l;
        param->comp[2][2] /= l;
