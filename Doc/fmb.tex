...
\section{Versions of this paper}

This paper has been revised has follow:

\begin{itemize}
\item February 5, 2020 : Original version
\item April 5, 2020 : Addition of the 'near-case only' results in qualification.
\item April 25, 2020 : Update of the qualification results after moving the computation of the inverse of components matrix from outside to inside the intersection detection test for a better comparison with SAT.
\end{itemize}
