...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../2D/algorithm.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../3D/algorithm.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../2DTime/algorithm.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../3DTime/algorithm.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../2DTime/validation.c}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../3DTime/validation.c}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/unitTests2D.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/unitTests3D.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/unitTests2DTime.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/unitTests3DTime.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/validation2D.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/validation2DTime.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/validation3D.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/validation3DTime.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../2D/qualification.c}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../3D/qualification.c}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../2DTime/qualification.c}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../3DTime/qualification.c}
\end{ttfamily}
\end{scriptsize}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/qualification2D.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{center}
\begin{figure}[H]
\centering\includegraphics[width=6cm]{../Results/qualification2DCCinter.png}
\centering\includegraphics[width=6cm]{../Results/qualification2DCTinter.png}\\
\centering\includegraphics[width=6cm]{../Results/qualification2DTCinter.png}
\centering\includegraphics[width=6cm]{../Results/qualification2DTTinter.png}\\
\end{figure}
\end{center}

\begin{center}
\begin{figure}[H]
\centering\includegraphics[width=6cm]{../Results/qualification2DCCnointer.png}
\centering\includegraphics[width=6cm]{../Results/qualification2DCTnointer.png}\\
\centering\includegraphics[width=6cm]{../Results/qualification2DTCnointer.png}
\centering\includegraphics[width=6cm]{../Results/qualification2DTTnointer.png}\\
\end{figure}
\end{center}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/qualification3D.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{center}
\begin{figure}[H]
\centering\includegraphics[width=6cm]{../Results/qualification3DCCinter.png}
\centering\includegraphics[width=6cm]{../Results/qualification3DCTinter.png}\\
\centering\includegraphics[width=6cm]{../Results/qualification3DTCinter.png}
\centering\includegraphics[width=6cm]{../Results/qualification3DTTinter.png}\\
\end{figure}
\end{center}

\begin{center}
\begin{figure}[H]
\centering\includegraphics[width=6cm]{../Results/qualification3DCCnointer.png}
\centering\includegraphics[width=6cm]{../Results/qualification3DCTnointer.png}\\
\centering\includegraphics[width=6cm]{../Results/qualification3DTCnointer.png}
\centering\includegraphics[width=6cm]{../Results/qualification3DTTnointer.png}\\
\end{figure}
\end{center}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/qualification2DTime.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{center}
\begin{figure}[H]
\centering\includegraphics[width=6cm]{../Results/qualification2DTimeCCinter.png}
\centering\includegraphics[width=6cm]{../Results/qualification2DTimeCTinter.png}\\
\centering\includegraphics[width=6cm]{../Results/qualification2DTimeTCinter.png}
\centering\includegraphics[width=6cm]{../Results/qualification2DTimeTTinter.png}\\
\end{figure}
\end{center}

\begin{center}
\begin{figure}[H]
\centering\includegraphics[width=6cm]{../Results/qualification2DTimeCCnointer.png}
\centering\includegraphics[width=6cm]{../Results/qualification2DTimeCTnointer.png}\\
\centering\includegraphics[width=6cm]{../Results/qualification2DTimeTCnointer.png}
\centering\includegraphics[width=6cm]{../Results/qualification2DTimeTTnointer.png}\\
\end{figure}
\end{center}
...
\begin{scriptsize}
\begin{ttfamily}
\verbatiminput{../Results/qualification3DTime.txt}
\end{ttfamily}
\end{scriptsize}
...
\begin{center}
\begin{figure}[H]
\centering\includegraphics[width=6cm]{../Results/qualification3DTimeCCinter.png}
\centering\includegraphics[width=6cm]{../Results/qualification3DTimeCTinter.png}\\
\centering\includegraphics[width=6cm]{../Results/qualification3DTimeTCinter.png}
\centering\includegraphics[width=6cm]{../Results/qualification3DTimeTTinter.png}\\
\end{figure}
\end{center}

\begin{center}
\begin{figure}[H]
\centering\includegraphics[width=6cm]{../Results/qualification3DTimeCCnointer.png}
\centering\includegraphics[width=6cm]{../Results/qualification3DTimeCTnointer.png}\\
\centering\includegraphics[width=6cm]{../Results/qualification3DTimeTCnointer.png}
\centering\includegraphics[width=6cm]{../Results/qualification3DTimeTTnointer.png}\\
\end{figure}
\end{center}
