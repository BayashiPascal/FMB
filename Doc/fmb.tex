...
FMB is then in average always slower (from 0.0 to 2.0 times).\\ 
...
FMB is then in average always faster (from 3.7 times to 1.4 times) than SAT whatever the combinaison of Tetrahedron and Cuboid and the percentage of intersection. In comparison to the general case, in 'near only mode' the FMB algorithm stays faster than the SAT algorithm for the 3D static case, but is same or slower in the 2D static case.\\
